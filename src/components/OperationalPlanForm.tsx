...
const OperationalPlanForm = ({ onSubmit, onCancel }: OperationalPlanFormProps) => {
  ...
  const [resourceExecutionDate, setResourceExecutionDate] = useState<Date | undefined>();
  const [executionStartDate, setExecutionStartDate] = useState<Date | undefined>();
      ...
      <div className="bg-white rounded-lg border shadow-sm p-6">
        ...
        <div className="space-y-6">
          <div className="p-5 border rounded-lg space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Valor do recurso disponível para o ano em execução</label>
              <RadioGroup
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Valor anual previsto</label>
          ...
          <div className="p-5 border rounded-lg space-y-6">
            <h3 className="text-base font-semibold">Especificação da rubrica</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Material de Consumo</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <span className="text-gray-500">R$</span>
                  </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Investimentos</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <span className="text-gray-500">R$</span>
                  </div>
          ...
          <div className="p-5 border rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Prazo para execução do recurso</label>
                <DatePicker 
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Período de Execução - Início</label>
                <DatePicker 
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Período de Execução - Fim</label>
                <DatePicker 
          ...
          <div className="p-5 border rounded-lg space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Auxílio Estudante?</label>
              <RadioGroup
            ...
            {needsAssistance === 'sim' && (
              <div className="space-y-2 animate-fade-in">
                <label className="text-sm font-medium text-gray-700">Com base na sua resposta anterior, especifique:</label>
                <textarea
          ...
          <div className="p-5 border rounded-lg bg-app-lightBlue space-y-4">
            <h3 className="text-base font-semibold text-app-blue">RESUMO DO PROJETO</h3>
            <p className="text-sm text-gray-600">
              Este é um resumo do projeto. Aqui escreva uma descrição detalhada sobre o projeto selecionado, seus objetivos, metas e outras informações relevantes para a execução do plano operacional.
            </p>
            <textarea
